# Chatbots — Tarefas de reconstrução
...
## Implementação
- [ ] Reconstruir **Modelar e publicar chatbot** por `modelar-publicar/requirements.md`; pronto quando os efeitos, falhas e retomadas estiverem testados. **[INFERIDO]**
- [ ] Reconstruir **Executar regras** por `executar-regras/requirements.md`; pronto quando os efeitos, falhas e retomadas estiverem testados. **[INFERIDO]**
- [ ] Reconstruir **Espera, handoff e IA** por `espera-handoff-ia/requirements.md`; pronto quando os efeitos, falhas e retomadas estiverem testados. **[INFERIDO]**
