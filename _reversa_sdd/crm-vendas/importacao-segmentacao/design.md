# Importação e segmentação — Design

## Fluxo

Upload → leitura incremental → mapeamento → validação por linha → confirmação → persistência/erros → segmento ou listagem **[CONFIRMADO]**
