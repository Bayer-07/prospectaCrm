...
- `GET/POST /api/v1/whatsapp/instances`. **[CONFIRMADO]**
- `POST /api/v1/whatsapp/instances/:id/connect`. **[CONFIRMADO]**
- `POST /api/v1/whatsapp/instances/:id/disconnect`. **[CONFIRMADO]**
- `DELETE /api/v1/whatsapp/instances/:id`. **[CONFIRMADO]**
- `GET/PATCH /api/v1/conversations/:id`. **[CONFIRMADO]**
- `POST /api/v1/conversations/:id/messages`. **[CONFIRMADO]**
- `POST /api/v1/webhooks/evolution/:instanceId`. **[CONFIRMADO]**
