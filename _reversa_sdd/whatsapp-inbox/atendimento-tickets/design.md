# Atendimento e tickets — Design

## Fluxo

Mensagem recebida → ticket aguardando → usuário assume → atendimento aberto → transferência ou finalização → reentrada aguardando **[CONFIRMADO]**
