# Conexões Evolution — Design

## Fluxo

Administrador cria instância → API provisiona Evolution → QR/eventos atualizam a instância → conexão fica disponível às equipes **[CONFIRMADO]**
