# Campanhas de WhatsApp e e-mail — Tarefas de reconstrução
...
## Implementação
- [ ] Reconstruir **Criar audiência** por `criar-audiencia/requirements.md`; pronto quando os efeitos, falhas e retomadas estiverem testados. **[INFERIDO]**
- [ ] Reconstruir **Executar campanha WhatsApp** por `executar-whatsapp/requirements.md`; pronto quando os efeitos, falhas e retomadas estiverem testados. **[INFERIDO]**
- [ ] Reconstruir **Executar campanha de e-mail** por `executar-email/requirements.md`; pronto quando os efeitos, falhas e retomadas estiverem testados. **[INFERIDO]**
- [ ] Reconstruir **Ciclo da campanha** por `ciclo-campanha/requirements.md`; pronto quando os efeitos, falhas e retomadas estiverem testados. **[INFERIDO]**
