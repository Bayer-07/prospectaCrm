...
export type Company = { id: string; name: string; legalName?: string; sector?: string; size?: string; domain?: string; linkedinUrl?: string | null; logoId?: string | null; cnpj?: string; email?: string | null; phone?: string; address?: Record<string, unknown>; createdAt?: string; updatedAt: string; owner?: { id: string; name: string }; team?: { id: string; name: string; color: string }; _count?: { contacts: number; opportunities: number } };
