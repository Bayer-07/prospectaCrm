...
export type Company = { id: string; name: string; legalName?: string; sector?: string; size?: string; domain?: string; cnpj?: string; phone?: string; address?: Record<string, unknown>; createdAt?: string; updatedAt: string; owner?: { id: string; name: string }; team?: { id: string; name: string; color: string }; _count?: { contacts: number; opportunities: number } };
