...
export function Shell() {
  ...
  useEffect(() => {
    ...
    const closeOnOutsidePointerDown = (event: PointerEvent) => {
      ...
      if (target instanceof Node && !notificationsPopoverRef.current?.contains(target)) setNotificationsOpen(false);
    };
